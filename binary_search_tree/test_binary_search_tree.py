...
import sys
import io
from binary_search_tree import BSTNode, printValues

class BinarySearchTreeTests(unittest.TestCase):
    def setUp(self):
        self.bst = BSTNode(5)
        # printValues(self.bst, f"init with value:\t5")
    ...
    def test_handle_dupe_insert(self):
        self.bst2 = BSTNode(1)
        # printValues(self.bst, f"init with value:\t1")
        self.assertEqual(self.bst2.count, 1)
        self.bst2.insert(1)
        self.assertEqual(self.bst2.count, 2)
